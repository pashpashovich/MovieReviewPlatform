...
<script>
    function editMovie(id, title, description, releaseYear, duration, language, selectedGenres, selectedActors, selectedDirectors, selectedProducers) {
        ...
        document.getElementById('movieForm').action = `${contextPath}/admin/movies/`+id;
    ...
    function resetForm() {
        ...
        document.getElementById('movieForm').action = `${contextPath}/admin/movies`;
                    ...
                    <c:forEach var="movie" items="${movies}">
                        <tr class="text-center align-middle">
                            ...
                            <td>
                                ...
                                <form method="post" action="${pageContext.request.contextPath}/admin/movies/${movie.id}"
